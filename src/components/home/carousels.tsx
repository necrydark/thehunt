...
//     title: "Help The Kids",
//     subtext: "Stream your progress and raise Funds with your community to help St. Jude.",
...
//     subtext: "Simply paste your clip's URL in your profile to register your points.",
...
//     subtext: "Join hundreds of hunters raising funds to help St Jude on Xbox, Playstation and PC.",
...
// const Carousels = () => {
//   return (
//     <section className="container max-w-3xl mx-auto pt-[5rem] flex flex-row justify-center items-center">
...
const Carousels = () => {
  return (
    <section className="container max-w-3xl mx-auto pt-[5rem] relative flex flex-row justify-center items-center z-10">
      <section className="w-full py-12 md:py-24 lg:py-32 bg-dark-background text-white">
        <div className="container flex flex-col justify-center mx-auto px-4 md:px-6">
          <Carousel opts={{ align: "start" }} className="w-full max-w-[600px] mx-auto">
            <CarouselContent className="-ml-4">
              {carouselItems.map((item, index) => (
                <CarouselItem key={index} className="pl-4">
                  <div className="p-1">
