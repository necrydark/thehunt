...
export default function CompleteProfileForm({ userId, completed }: Props) {
  ...
  return (
    <Card className="border max-w-[800px] border-white/10 mt-8 shadow-md shadow-primary-green rounded-xl p-6 bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all duration-300 group">
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  disabled={
                    ...
                    completeFormMutation.isSuccess
                  }
                >
                  {completeFormMutation.isPending
                    ? "Completing..."
